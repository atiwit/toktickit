...
Prompt : Prepare all required engineering documents before any implementation begins. (Issue 1) (Claude Sonnet 4.5)
...
Prompt : Design the Prisma database schema for Lab 2 including RequesterUser, Category, RelatedSystem, Ticket,Attachment for BR-18 Lab 3 migration compatibility. (Issue 2) (Claude Sonnet 4.5)
...
Prompt : Implement the full backend API for Create Ticket with ticket number generation in TKT-YYYYMMDD-NNNN format, validation for all required fields, and ownership verification. (Issue 4) (Claude Sonnet 4.5)
...
Prompt : Guide me on attachment upload, download, and soft-remove endpoints with multer (Issue 5) (Gemini pro 3.1)
